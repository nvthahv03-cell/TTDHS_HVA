    ...
    <div class="relative z-10 flex flex-col gap-3.5">
        ...
        <div class="grid grid-cols-4 gap-2 text-center">
            <div class="p-2 rounded-2xl bg-slate-800/80 border border-slate-700/60 shadow-sm">
                ...
                <div class="text-sm font-black text-blue-400 mt-0.5 tabular-nums">94%</div>
            </div>
            <div class="p-2 rounded-2xl bg-slate-800/80 border border-slate-700/60 shadow-sm">
                <div class="text-[9px] text-slate-400 font-semibold uppercase">Hệ thống</div>
                <div class="text-sm font-black text-emerald-400 mt-0.5 tabular-nums">Ổn định</div>
            </div>
            <div class="p-2 rounded-2xl bg-slate-800/80 border border-slate-700/60 shadow-sm">
            ...
            <div class="p-2 rounded-2xl bg-slate-800/80 border border-slate-700/60 shadow-sm">
                ...
                <div class="text-sm font-black text-rose-400 mt-0.5 tabular-nums">01</div>
            </div>
        </div>

        <div class="flex items-center justify-between text-[10px] text-slate-300 pt-1 font-medium px-1 bg-slate-800/50 p-2 rounded-xl border border-slate-700/40">
            <span class="flex items-center gap-1.5"><i class="bi bi-broadcast text-cyan-400"></i> <strong class="text-white font-bold">Bản tin điều hành:</strong> Tập trung chuẩn bị cơ sở vật chất năm học mới và rà soát tiến độ hội đồng coi thi.</span>
        </div>
    </div>
</div>
...
<div class="grid grid-cols-5 gap-2 mb-5">
    ...
    <button data-open-modal="team-modal" class="flex flex-col items-center gap-1.5 p-2.5 rounded-2xl bg-white border border-slate-100 shadow-sm hover:shadow-md hover:border-orange-200 active:scale-95 transition-all group">
        ...
        <span class="text-[10px] font-bold text-slate-700 text-center leading-tight">Lịch công tác</span>
    </button>
    ...
    <button data-open-modal="digital-modal" class="flex flex-col items-center gap-1.5 p-2.5 rounded-2xl bg-white border border-slate-100 shadow-sm hover:shadow-md hover:border-cyan-200 active:scale-95 transition-all group">
        ...
        <span class="text-[10px] font-bold text-slate-700 text-center leading-tight">Điều hành số</span>
    </button>
    <button data-open-modal="boiduong-modal" class="flex flex-col items-center gap-1.5 p-2.5 rounded-2xl bg-white border border-slate-100 shadow-sm hover:shadow-md hover:border-purple-200 active:scale-95 transition-all group">
        ...
        <span class="text-[10px] font-bold text-slate-700 text-center leading-tight">Nhiệm vụ</span>
    </button>
</div>
...
<section class="grid grid-cols-2 gap-3.5 mb-4">
    <div data-open-modal="digital-modal" class="group relative rounded-3xl bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 text-white p-4 shadow-lg hover:shadow-2xl transition-all duration-300 cursor-pointer overflow-hidden border border-blue-700/50 active:scale-[0.98]">
        ...
        <div class="absolute top-3 right-3 px-2 py-0.5 rounded-full bg-blue-500/30 text-[9px] font-extrabold text-blue-200 border border-blue-400/30 uppercase">ĐH</div>
    ...
    <div data-open-modal="digital-modal" class="group relative rounded-3xl bg-gradient-to-br from-cyan-900 via-teal-900 to-slate-900 text-white p-4 shadow-lg hover:shadow-2xl transition-all duration-300 cursor-pointer overflow-hidden border border-cyan-700/50 active:scale-[0.98]">
        ...
        <div class="absolute top-3 right-3 px-2 py-0.5 rounded-full bg-cyan-500/30 text-[9px] font-extrabold text-cyan-200 border border-cyan-400/30 uppercase">QT</div>
        <div class="w-12 h-12 rounded-2xl bg-white/15 backdrop-blur-md flex items-center justify-center shadow-inner mb-4 group-hover:scale-110 transition-transform duration-300 border border-white/20">
            <i class="bi bi-shield-lock-fill text-cyan-300 text-xl"></i>
        </div>
        <h3 class="text-xs font-extrabold tracking-tight text-white mb-1">Điều hành số</h3>
    ...
    <div data-open-modal="boiduong-modal" class="group relative rounded-3xl bg-gradient-to-br from-purple-900 via-indigo-950 to-slate-900 text-white p-4 shadow-lg hover:shadow-2xl transition-all duration-300 cursor-pointer overflow-hidden border border-purple-700/50 active:scale-[0.98]">
        ...
        <div class="absolute top-3 right-3 px-2 py-0.5 rounded-full bg-purple-500/30 text-[9px] font-extrabold text-purple-200 border border-purple-400/30 uppercase">TN</div>
        <div class="w-12 h-12 rounded-2xl bg-white/15 backdrop-blur-md flex items-center justify-center shadow-inner mb-4 group-hover:scale-110 transition-transform duration-300 border border-white/20">
            <i class="bi bi-clipboard-data-fill text-purple-300 text-xl"></i>
        </div>
        <h3 class="text-xs font-extrabold tracking-tight text-white mb-1">Tác nghiệp chuyên môn</h3>
    ...
    <div data-open-modal="team-modal" class="group relative rounded-3xl bg-gradient-to-br from-amber-950 via-orange-950 to-slate-900 text-white p-4 shadow-lg hover:shadow-2xl transition-all duration-300 cursor-pointer overflow-hidden border border-orange-700/50 active:scale-[0.98]">
        ...
        <div class="absolute top-3 right-3 px-2 py-0.5 rounded-full bg-orange-500/30 text-[9px] font-extrabold text-orange-200 border border-orange-400/30 uppercase">CS</div>
        <div class="w-12 h-12 rounded-2xl bg-white/15 backdrop-blur-md flex items-center justify-center shadow-inner mb-4 group-hover:scale-110 transition-transform duration-300 border border-white/20">
            <i class="bi bi-calendar-event-fill text-orange-300 text-xl"></i>
        </div>
        <h3 class="text-xs font-extrabold tracking-tight text-white mb-1">Lịch công tác</h3>
