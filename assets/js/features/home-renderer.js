...
<div class="mb-4 p-3.5 rounded-2xl bg-slate-900 text-white shadow-lg border border-slate-800 relative overflow-hidden">
    ...
    <div class="relative z-10 flex flex-col gap-3">
        ...
        <div class="flex items-center justify-between text-[10px] text-slate-300 font-medium px-2.5 py-1.5 bg-slate-800/50 rounded-xl border border-slate-700/40">
            <span class="flex items-center gap-1.5"><i class="bi bi-broadcast text-cyan-400 shrink-0"></i> <span class="truncate"><strong class="text-white font-bold">Bản tin:</strong> Tập trung chuẩn bị cơ sở vật chất năm học mới và rà soát tiến độ hội đồng coi thi.</span></span>
        </div>
    </div>
</div>
...
<div class="grid grid-cols-5 gap-1.5 mb-4">
    ...
    <button data-open-modal="team-modal" class="flex flex-col items-center gap-1 p-2 rounded-2xl bg-white border border-slate-100 shadow-sm hover:shadow-md hover:border-orange-200 active:scale-95 transition-all group">
        ...
        <span class="text-[9px] font-bold text-slate-700 text-center leading-tight">Lịch công tác</span>
    </button>
    ...
    <button data-open-modal="digital-modal" class="flex flex-col items-center gap-1 p-2 rounded-2xl bg-white border border-slate-100 shadow-sm hover:shadow-md hover:border-cyan-200 active:scale-95 transition-all group">
        ...
        <span class="text-[9px] font-bold text-slate-700 text-center leading-tight">Điều hành số</span>
    </button>
...
<!-- GRID MODULE (GỌN GÀNG, TẬP TRUNG ĐIỀU HÀNH - TÁC NGHIỆP - QUẢN TRỊ) -->
<section class="grid grid-cols-2 gap-3 mb-2">
    <div data-open-modal="digital-modal" class="group relative rounded-2xl bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 text-white p-3.5 shadow-md hover:shadow-xl transition-all duration-300 cursor-pointer overflow-hidden border border-blue-700/50 active:scale-[0.98]">
        ...
        <div class="absolute top-2.5 right-2.5 px-1.5 py-0.2 rounded-full bg-blue-500/30 text-[8px] font-extrabold text-blue-200 border border-blue-400/30 uppercase">ĐH</div>
        <div class="w-10 h-10 rounded-xl bg-white/15 backdrop-blur-md flex items-center justify-center shadow-inner mb-3 group-hover:scale-110 transition-transform duration-300 border border-white/20">
            <i class="bi bi-house-door-fill text-cyan-300 text-lg"></i>
        </div>
        <h3 class="text-xs font-extrabold tracking-tight text-white mb-0.5">Trang chủ TTĐHS</h3>
        <p class="text-[10px] text-blue-200/80 font-medium">Trung tâm Điều hành Số</p>
    </div>

    <div data-open-modal="digital-modal" class="group relative rounded-2xl bg-gradient-to-br from-cyan-900 via-teal-900 to-slate-900 text-white p-3.5 shadow-md hover:shadow-xl transition-all duration-300 cursor-pointer overflow-hidden border border-cyan-700/50 active:scale-[0.98]">
        ...
        <div class="absolute top-2.5 right-2.5 px-1.5 py-0.2 rounded-full bg-cyan-500/30 text-[8px] font-extrabold text-cyan-200 border border-cyan-400/30 uppercase">QT</div>
        <div class="w-10 h-10 rounded-xl bg-white/15 backdrop-blur-md flex items-center justify-center shadow-inner mb-3 group-hover:scale-110 transition-transform duration-300 border border-white/20">
            <i class="bi bi-shield-lock-fill text-cyan-300 text-lg"></i>
        </div>
        <h3 class="text-xs font-extrabold tracking-tight text-white mb-0.5">Điều hành số</h3>
        <p class="text-[10px] text-cyan-200/80 font-medium">Dashboard Quản trị BGH</p>
    </div>

    <div data-open-modal="boiduong-modal" class="group relative rounded-2xl bg-gradient-to-br from-purple-900 via-indigo-950 to-slate-900 text-white p-3.5 shadow-md hover:shadow-xl transition-all duration-300 cursor-pointer overflow-hidden border border-purple-700/50 active:scale-[0.98]">
        ...
        <div class="absolute top-2.5 right-2.5 px-1.5 py-0.2 rounded-full bg-purple-500/30 text-[8px] font-extrabold text-purple-200 border border-purple-400/30 uppercase">TN</div>
        <div class="w-10 h-10 rounded-xl bg-white/15 backdrop-blur-md flex items-center justify-center shadow-inner mb-3 group-hover:scale-110 transition-transform duration-300 border border-white/20">
            <i class="bi bi-clipboard-data-fill text-purple-300 text-lg"></i>
        </div>
        <h3 class="text-xs font-extrabold tracking-tight text-white mb-0.5">Tác nghiệp chuyên môn</h3>
        <p class="text-[10px] text-purple-200/80 font-medium">Báo cáo • Tập huấn • CM</p>
    </div>

    <div data-open-modal="team-modal" class="group relative rounded-2xl bg-gradient-to-br from-amber-950 via-orange-950 to-slate-900 text-white p-3.5 shadow-md hover:shadow-xl transition-all duration-300 cursor-pointer overflow-hidden border border-orange-700/50 active:scale-[0.98]">
        <div class="absolute top-0 right-0 w-20 h-20 bg-orange-400/10 rounded-full blur-xl group-hover:scale-150 transition-all duration-500"></div>
        <div class="absolute top-2.5 right-2.5 px-1.5 py-0.2 rounded-full bg-orange-500/30 text-[8px] font-extrabold text-orange-200 border border-orange-400/30 uppercase">CS</div>
        <div class="w-10 h-10 rounded-xl bg-white/15 backdrop-blur-md flex items-center justify-center shadow-inner mb-3 group-hover:scale-110 transition-transform duration-300 border border-white/20">
            <i class="bi bi-calendar-event-fill text-orange-300 text-lg"></i>
        </div>
        <h3 class="text-xs font-extrabold tracking-tight text-white mb-0.5">Lịch công tác</h3>
        <p class="text-[10px] text-orange-200/80 font-medium">Lịch tuần • Lịch tháng</p>
    </div>
</section>
`;
}
